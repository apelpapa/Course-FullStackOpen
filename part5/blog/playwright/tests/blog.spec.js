...
const { attemptLogin, addNewBlog } = require('./helper')
...
describe("Blog app", () => {
  ...
  describe('When Logged In', () => {
    beforeEach(async ({ page }) => {
        await attemptLogin(page, 'test1', 'test1')
        await addNewBlog(page, 'Test Title 1', 'Test Author 1', 'www.testurl1.com')
        await addNewBlog(page, 'Test Title 2', 'Test Author 2', 'www.testurl2.com')
        await addNewBlog(page, 'Test Title 3', 'Test Author 3', 'www.testurl3.com')
    })

    test('New Blog Can Be Created', async ({ page }) =>{
        await addNewBlog(page, 'Test Title 4', 'Test Author 4', 'www.testurl4.com')
